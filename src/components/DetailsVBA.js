      ...
      <div className="desc">
        ...
        <p>
          ...
          <ul>
            ...
            <li>Tri automatiques des données</li>
            <li>...</li>
          </ul>
        </p>
        <p>
          Le langage VBA étant limité sur ces logiciels, certaines fonctions
          n'étaient parfois pas disponible (exemple : Sur PowerPoint, les
          évènements lié à la souris ne sont pas intégrés), il fallait bien
          souvent être inventif, et être persévérant dans les recherches, pour
          contourner les problèmes et arriver à nos fins.
        </p>
        <p>
        ...
        <ul>
          ...
          <ul>
            <li>
              Catia n'a pas la fonction pour calculer cette surface, mais il est
            ...
            <li>
              ...
              de pixels blancs, nous pouvions calculer la surfaces souhaitée
